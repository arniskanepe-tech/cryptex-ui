(() => {
  ...
  function buildCryptex(){
    ...
    ringsCount = Math.max(1, Math.min(30, Number(ringsCountEl.value)||4));
  ...
  ringsCountEl.addEventListener("change", () => normalizeSolution(Math.max(1, Math.min(30, Number(ringsCountEl.value)||4))));
